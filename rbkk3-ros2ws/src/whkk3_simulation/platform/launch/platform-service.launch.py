...
def generate_launch_description():
    ...
    launch_arg_namespace = DeclareLaunchArgument(
        'namespace',
        default_value='whkk3_ns',
    ...
    pkg_whkk3_simulation = get_package_share_directory('whkk3_simulation')

    # Declare launch files
    launch_file_platform = PathJoinSubstitution([
        pkg_whkk3_simulation, 'launch', 'platform.launch.py'])
    ...
    node_gtruth_base_tf_bridge = Node(
        name='gtruth_base_tf_bridge',
        executable='parameter_bridge',
        package='ros_gz_bridge',
        namespace='whkk3_ns',
        output='screen',
        arguments=
            [
                '/model/whkk3/pose@tf2_msgs/msg/TFMessage[ignition.msgs.Pose_V'
                ,
            ]
        ,
        remappings=
    ...
    ld.add_action(node_gtruth_base_tf_bridge)
    return ld
